...
<div class="min-h-screen pt-20">
    <div class="mx-auto max-w-2xl px-4 py-8 lg:px-8">
        ...
        <h1 class="mb-8 text-2xl font-bold text-text-primary dark:text-white">Edit Instruktur</h1>
        ...
        <div class="rounded-2xl border border-border bg-surface-alt p-8 shadow-sm dark:border-gray-700 dark:bg-dark-surface">
            <form method="POST" action="{{ route('admin.instructors.update', $instructor) }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="expertise" value="{{ old('expertise', $instructor->expertise) }}"
                        class="w-full rounded-xl border border-border bg-white px-4 py-3 text-sm outline-none focus:border-primary-start focus:ring-1 focus:ring-primary-start dark:border-gray-600 dark:bg-dark-bg dark:text-white">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="bio" rows="4"
                        class="w-full rounded-xl border border-border bg-white px-4 py-3 text-sm outline-none focus:border-primary-start focus:ring-1 focus:ring-primary-start dark:border-gray-600 dark:bg-dark-bg dark:text-white">{{ old('bio', $instructor->bio) }}</textarea>
